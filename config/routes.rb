JamWithFriends::Application.routes.draw do
  ...
  get "jam_managements/withdraw_candidate", to: 'jam_managements#withdraw_candidate', as: "withdraw_candidate_from_jam" 
  get "jam_managements/refuse_infite", to: 'jam_managements#refuse_invite', as: 'refuse_invitation_from_jam'
